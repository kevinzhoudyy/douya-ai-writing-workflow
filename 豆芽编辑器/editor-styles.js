{
  ...
  'gaudi-organic': {
    ...
    styles: {
      ...
      h3: 'font-size: 21px; font-weight: 600; color: #27ae60 !important; line-height: 1.35 !important; margin: 28px 0 14px; padding-left: 24px; position: relative;',
      ...
      hr: 'margin: 36px auto; border: none; height: 24px; background: url("data:image/svg+xml,%3Csvg width=%27100%27 height=%2730%27 xmlns=%27http://www.w3.org/2000/svg%27%3E%3Cpath d=%27M0,15 Q25,0 50,15 T100,15%27 stroke=%27%23c0392b%27 stroke-width=%272%27 fill=%27none%27/%3E%3C/svg%3E") repeat-x center; background-size: 80px 24px; max-width: 240px;',
  ...
  'lemonde': {
    ...
    styles: {
      ...
      hr: 'margin: 36px auto; border: none; text-align: center; height: 20px; background: url("data:image/svg+xml,%3Csvg width=%2780%27 height=%2720%27 xmlns=%27http://www.w3.org/2000/svg%27%3E%3Ctext x=%2740%27 y=%2712%27 text-anchor=%27middle%27 font-size=%2720%27 fill=%27%232c2c2c%27%3E%E2%81%82%3C/text%3E%3C/svg%3E") no-repeat center; background-size: 80px 20px;',
  ...
  'xhs-text': {
    name: '小红书文字帖',
    styles: {
      container: 'max-width: 620px; margin: 0 auto; padding: 18px 18px 42px 18px; font-family: -apple-system, BlinkMacSystemFont, "PingFang SC", "Noto Sans SC", "Helvetica Neue", Arial, sans-serif; font-size: 16px; line-height: 1.9 !important; color: #2b2b2b !important; background-color: #ffffff !important; word-wrap: break-word; letter-spacing: 0;',
      h1: 'font-size: 28px; font-weight: 700; color: #2b2b2b !important; line-height: 1.3 !important; margin: 20px 0 16px;',
      h2: 'font-size: 20px; font-weight: 700; color: #2b2b2b !important; line-height: 1.45 !important; margin: 28px 0 12px;',
      h3: 'font-size: 17px; font-weight: 700; color: #2b2b2b !important; line-height: 1.5 !important; margin: 24px 0 10px;',
      h4: 'font-size: 16px; font-weight: 700; color: #2b2b2b !important; line-height: 1.55 !important; margin: 20px 0 8px;',
      h5: 'font-size: 15px; font-weight: 600; color: #2b2b2b !important; line-height: 1.55 !important; margin: 18px 0 8px;',
      h6: 'font-size: 14px; font-weight: 600; color: #2b2b2b !important; line-height: 1.55 !important; margin: 16px 0 8px;',
      p: 'margin: 16px 0 20px !important; line-height: 1.95 !important; color: #2b2b2b !important; font-size: 16px;',
      strong: 'font-weight: 700; color: #2b2b2b !important;',
      em: 'font-style: normal; color: #2b2b2b !important; font-weight: 600;',
      a: 'color: #2b2b2b !important; text-decoration: underline;',
      ul: 'margin: 14px 0 20px; padding-left: 22px; list-style-type: disc;',
      ol: 'margin: 14px 0 20px; padding-left: 22px; list-style-type: decimal;',
      li: 'margin: 8px 0 12px; line-height: 1.9 !important; color: #2b2b2b !important;',
      blockquote: 'margin: 18px 0 22px; padding: 0 0 0 12px; background-color: transparent !important; border-left: 3px solid #d0d0d0; color: #2b2b2b !important; line-height: 1.75 !important;',
      code: 'font-family: "SF Mono", Monaco, Menlo, monospace; font-size: 14px; padding: 0; background-color: transparent !important; color: #2b2b2b !important; border-radius: 0;',
      pre: 'margin: 22px 0; padding: 0; background-color: transparent !important; border: none; border-radius: 0; overflow-x: auto; line-height: 1.6 !important;',
      hr: 'margin: 28px 0; border: none; border-top: 1px solid #d9d9d9; height: 0; background: none; max-width: none;',
      img: 'max-width: 100%; max-height: 460px !important; height: auto; display: block; margin: 20px auto;',
      table: 'width: 100%; margin: 22px 0; border-collapse: collapse; font-size: 15px;',
      th: 'padding: 10px 12px; text-align: left; border: 1px solid #d9d9d9; font-weight: 700; color: #2b2b2b !important; background-color: transparent !important;',
      td: 'padding: 10px 12px; border: 1px solid #d9d9d9; color: #2b2b2b !important;',
